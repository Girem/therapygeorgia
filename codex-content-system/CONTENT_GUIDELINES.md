...
## პროექტის სტილის წესები

- ქართულ ტექსტში უპირატესობა მიანიჭე ბუნებრივ ქართულ სიტყვათწყობას: გრძელი ჩამონათვლის ან ფრაზის შემდეგ მთავარი ზმნა ხშირად წინადადების ბოლოს გადაიტანე, თუ ასე უფრო ბუნებრივად ჟღერს.
